...
#include <memory>
#include "../../SpaceInvidors/gameplay.h"
...
QT_MOC_LITERAL(4, 44, 10), // "on_timeout"
QT_MOC_LITERAL(5, 55, 11), // "lvl_changed"
QT_MOC_LITERAL(6, 67, 23) // "on_pushButton_2_clicked"

    },
    "GamePlay\0firstWindow\0\0on_pushButton_clicked\0"
    "on_timeout\0lvl_changed\0on_pushButton_2_clicked"
};
...
void GamePlay::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&GamePlay::firstWindow)) {
                *result = 0;
                return;
            }
        }
